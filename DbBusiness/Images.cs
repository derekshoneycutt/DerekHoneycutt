...
{
    /// <summary>
    /// Methods for converting images from the database to business code representation
    /// </summary>
    public static class Images
    {
        ...
        public static BusinessModels.Image Parse(DbModels.Image i)
        {
        ...
        public static async Task<BusinessModels.Image> GetById(
